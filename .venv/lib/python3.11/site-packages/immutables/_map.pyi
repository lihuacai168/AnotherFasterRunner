import sys
from typing import Any, Dict, Generic, Iterable, Iterator, Mapping, Optional, Tuple, Type, Union, overload

if sys.version_info >= (3, 9):
    from types import GenericAlias

from ._protocols import HT, KT, IterableItems, MapItems, MapKeys, MapMutation, MapValues, T, VT_co
