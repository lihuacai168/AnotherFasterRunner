...
urlpatterns = [
    ...
    path(
        "project/yapi/<int:pk>/",
        project.ProjectView.as_view({"get": "yapi_info"}),
    ),
    ...
    path(
        "debugtalk/<int:pk>/",
        project.DebugTalkView.as_view({"get": "debugtalk"}),
    ),
    path(
        "debugtalk/",
        project.DebugTalkView.as_view({"patch": "update", "post": "run"}),
    ),
    # 二叉树接口地址
    ...
    path(
        "variables/<int:pk>/",
        config.VariablesView.as_view({"delete": "delete", "patch": "update"}),
    ),
    # run api
