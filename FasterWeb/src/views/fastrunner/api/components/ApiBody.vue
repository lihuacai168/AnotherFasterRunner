      ...
      <el-tabs style="margin-left: 20px" v-model="activeTag">
        <el-tab-pane label="Header" name="first">
          <span slot="label">
            ...
            <el-badge
              slot="label"
              :value="
                handleBadgeValue(response ? response.body.header : [], 'key')
              "
            ></el-badge>
          </span>
          <headers
        ...
        <el-tab-pane label="Extract" name="third">
          <span slot="label">
            ...
            <el-badge
              slot="label"
              :value="
                handleBadgeValue(response ? response.body.extract : [], 'key')
              "
            ></el-badge>
          </span>
          <extract
        ...
        <el-tab-pane label="Variables" name="five">
          <span slot="label">
            ...
            <el-badge
              slot="label"
              :value="
                handleBadgeValue(response ? response.body.variables : [], 'key')
              "
            ></el-badge>
          </span>
          <variables
        ...
        <el-tab-pane label="Hooks" name="six">
          <span slot="label"
            ...
            <el-badge
              slot="label"
              :value="handleHooksBadge(response ? response.body.hooks : [])"
            ></el-badge>
          </span>
          <hooks
            :save="save"
