          ...
          <el-dialog title="添加项目" :visible.sync="dialogVisible" width="40%">
            ...
            >
              ...
              <el-form-item label="YAPI地址" prop="yapi_base_url">
                <el-input
                  v-model="projectForm.yapi_base_url"
                  clearable
                ></el-input>
              </el-form-item>
              ...
              <el-form-item label="YAPI token" prop="yapi_openapi_token">
                <el-input
                  v-model="projectForm.yapi_openapi_token"
                  clearable
                ></el-input>
              </el-form-item>
              ...
              <el-form-item label="JIRA bearer token" prop="jira_bearer_token">
                <el-input
                  v-model="projectForm.jira_bearer_token"
                  clearable
                ></el-input>
              </el-form-item>
            ...
            <span slot="footer" class="dialog-footer">
              ...
              <el-button type="primary" @click="handleConfirm('projectForm')"
                >确 定</el-button
              >
            </span>
          </el-dialog>
          ...
          <el-table-column label="操作" align="center" width="230">
            <template v-slot="scope">
              ...
              <el-button
                ...
                style="margin-left: 5px"
                :title="
                  isSuperuser || userName === scope.row.responsible
                    ? '编辑项目'
                    : '权限不足，请联系管理员'
                "
              ...
              >
                ...
                <span slot="footer" class="dialog-footer">
                  <el-button size="medium" @click="closeEditDialog"
                    >取 消</el-button
                  >
                  <el-button
                    size="medium"
