        ...
        <el-header style="background: #fff; padding: 0; height: 50px">
            <div class="nav-api-header">
                <div style="padding-top: 10px; margin-left: 20px">
                    <el-button type="warning" size="small" icon="el-icon-circle-plus-outline" @click="initResponse = true">新增配置</el-button>
                    ...
                    <el-button style="margin-left: 20px" type="danger" icon="el-icon-delete" circle size="mini" @click="del= !del"></el-button>
                    <el-button :disabled="!addConfigActivate" type="text" style="position: absolute; right: 30px;" @click="addConfigActivate=false">返回列表</el-button>
                </div>
            </div>
        </el-header>
...
export default {
    ...
    methods: {
        ...
        handleRespConfig(row) {this.respConfig = row;this.addConfigActivate = true;}
    },
    name: "RecordConfig",
    mounted() {}
}
