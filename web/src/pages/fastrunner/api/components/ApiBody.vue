    ...
    <div>
        <div>
            <div>
                ...
                <el-button slot="append" type="success" size="medium" :title="
                    userName === creator || isSuperuser || !isSaveAs
                        ? '保存'
                        : '只有API创建者才能更新'
                " :disabled="userName !== creator && !isSuperuser && isSaveAs" @click="save = !save">Save
                </el-button>

                <el-button style="margin-left: 0" size="medium" slot="append" type="success" :title="'另存为'"
                    @click="handleSaveAs">Save As
                </el-button>

                <el-button style="margin-left: 0" size="medium" type="primary" @click="reverseStatus"
                    v-loading="loading" :disabled="loading">Send
                </el-button>
            </div>

            <div>
                <el-input style="width: 60%; margin-top: 10px;min-width: 500px" placeholder="请输入接口请求地址" v-model="url"
                    clearable>
                    <el-select style="width: 100px" slot="prepend" v-model="method">
                        <el-option v-for="item of httpOptions" :label="item.label" :value="item.label"
                            :key="item.value">
                        </el-option>
                    </el-select>
            ...
            <el-tabs style="margin-left: 20px;" v-model="activeTag">
                ...
                <el-tab-pane label="Extract" name="third">
                    <span slot="label">
                        Extract
                        <el-badge slot="label"
                                  :value="handleBadgeValue(response ? response.body.extract : [],'key')"
                        ></el-badge>
                    </span>
                ...
                <el-tab-pane label="Validate" name="fourth">
                    ...
                    <validate :save="save" v-on:validate="handleValidate"
                ...
                <el-tab-pane label="Variables" name="five">
                    ...
                    <variables :save="save" v-on:variables="handleVariables"
