                    ...
                    <el-table-column label="操作" align="center" width="230">
                        <template v-slot="scope">
                            ...
                            <el-button
                                ...
                                type="primary"
                                style="margin-left: 0"
                                :title=" isSuperuser || userName === scope.row.responsible
                                        ? '编辑项目' : '权限不足，请联系管理员'"
                            ...
                            <el-dialog title="编辑项目" :visible.sync="editVisible" width="40%">
                                ...
                                <span slot="footer" class="dialog-footer">
                                    ...
                                    <el-button size="medium" type="primary"
                                               @click="handleConfirm('projectForm')">确 定</el-button
                                    >
                                </span>
                            </el-dialog>
                            <el-button size="small" type="danger" v-show="isSuperuser" :title="
                                isSuperuser ? '删除项目' : '权限不足，请联系管理员'"
                                :disabled="!isSuperuser"
