<template>
  <el-main v-loading="loading" element-loading-text="正在玩命加载">
    ...
    <ul class="project_detail" v-if="false">
      <li class="pull-left">
    ...
    <div class="cards">
      <el-card style="width: 450px; margin-right: 5px">
        <div slot="header">
          <span>API</span>
          <i class="iconfont">&#xe74a;</i>
        </div>
    ...
    <div style="display: flex; height: 360px; margin-top: 10px" v-if="false">
    ...
    <div class="cards">
      <el-card style="width: 450px; height: 360px; margin-right: 5px">
        <div slot="header">
          <span>Report</span>
          <i class="iconfont">&#xe66e;</i>
        </div>
      ...
      <el-card style="width: 450px; height: 360px">
