...
import { addUserInfo, queryUserInfo, removeUserInfo, updateUserInfo, queryUserInfoVerboseName, queryUserInfoListDisplay, queryUserInfoDisplayOrder} from './service';
...
const TableList = () => {
  ...
  useEffect(() => {
    queryUserInfoDisplayOrder().then(r => {
  ...
  useEffect(() => {
    queryUserInfoListDisplay().then(value => {
    ...
    <PageHeaderWrapper>
      <ProTable
        ...
        toolBarRender={(action, { selectedRows }) => [
          ...
          <Button type="primary" onClick={() => exportExcelAll(paramState, queryUserInfo, table_columns, '用户信息-All')}>
            <ExportOutlined /> 导出全部
          </Button>,
